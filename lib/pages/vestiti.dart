...
class Vestiti extends StatefulWidget {
  @override
  _VestitiState createState() => _VestitiState();
}

class _VestitiState extends State<Vestiti> {
  String tipoPagina = 'Vestiti';
  String titoloLista;
  Color colore = vestitiTypeColor;
