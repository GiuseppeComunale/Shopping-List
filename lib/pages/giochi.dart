...
class Giochi extends StatefulWidget {
  @override
  _GiochiState createState() => _GiochiState();
}

class _GiochiState extends State<Giochi> {
  String tipoPagina = 'Giochi';
  String titoloLista;
  Color colore = giochiTypeColor;
