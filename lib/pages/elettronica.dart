...
class Elettronica extends StatefulWidget {
  @override
  _ElettronicaState createState() => _ElettronicaState();
}

class _ElettronicaState extends State<Elettronica> {
  String tipoPagina = 'Elettronica';
  String titoloLista;
  Color colore = elettronicaTypeColor;
