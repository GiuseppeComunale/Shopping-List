...
class Libri extends StatefulWidget {
  @override
  _LibriState createState() => _LibriState();
}

class _LibriState extends State<Libri> {
  String tipoPagina = 'Libri';
  String titoloLista;
  Color colore = libriTypeColor;
